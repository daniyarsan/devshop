<div id="mobileMenu" class="hidden bg-darkblue fixed inset-0 z-[9999]">
    <div class="container">
        <div class="mmenu-heading flex items-center pt-6 xl:pt-12">
            <div class="shrink-0 grow">
                <a href="index.html" rel="home">
                    <img src="{{Vite::image('logo.png')}}" class="w-[148px] md:w-[201px] h-[36px] md:h-[50px]" alt="DevShop">
                </a>
            </div>
            <div class="shrink-0 flex items-center">
                <button id="closeMobileMenu" class="text-white hover:text-purple transition">
        ...
        <div class="mmenu-inner pt-10">
            <!-- <a href="login.html" class="profile flex items-center mr-12">
                ...
                <span class="profile-text relative ml-2 text-white font-bold">Войти</span>
            </a> -->
            <div class="flex items-center">
                <img src="./images/avatar.jpg" class="w-14 h-14 rounded-full" alt="Daniyarsan">
                <div class="flex flex-col items-start ml-4">
                    <span class="text-white text-xs md:text-sm font-bold">Daniyarsan</span>
            ...
            <nav class="flex flex-col mt-8">
                <a href="index.html" class="self-start py-1 text-white hover:text-pink text-md font-bold">Главная</a>
                <a href="catalog.html" class="self-start py-1 text-white hover:text-pink text-md font-bold">Каталог товаров</a>
                <a href="orders.html" class="self-start py-1 text-white hover:text-pink text-md font-bold">Мои заказы</a>
                <a href="cart.html" class="self-start py-1 text-white hover:text-pink text-md font-bold">Корзина</a>
            </nav>
            <div class="flex flex-wrap items-center space-x-6 mt-8">
                <a href="#" class="inline-flex items-center text-whiteblue hover:text-purple" target="_blank" rel="nofollow noopener">
