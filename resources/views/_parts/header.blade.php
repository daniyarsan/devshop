        ...
        <div class="header-inner flex items-center justify-between lg:justify-start">
            <div class="header-logo shrink-0">
                <a href="{{route('home')}}" rel="home">
                    <img src="{{Vite::image('logo.png')}}" class="w-[120px] xs:w-[148px] md:w-[201px] h-[30px] xs:h-[36px] md:h-[50px]" alt="DevShop">
                </a>
            </div><!-- /.header-logo -->
                    ...
                    <div x-data="{dropdownProfile: false}" class="profile relative">
                        ...
                        >
                            ...
                            <div class="flex items-center mt-3">
                                <img src="{{auth()->user()->avatar}}" class="w-11 h-11 rounded-full" alt="Daniyarsan">
                            ...
                            <div class="mt-6">
                                    ...
                                    <form action="{{route('user.logout')}}" method="post">
                                        ...
                                        <button type="submit" href="{{route('user.logout')}}" class="inline-flex items-center text-body hover:text-pink">
