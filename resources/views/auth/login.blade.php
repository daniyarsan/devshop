...
@section('content')
    ...
    <x-form.auth-form
        ...
        <x-form.primary-button>Войти</x-form.primary-button>
        ...
        <x-slot:buttons>
            <div class="space-y-3 mt-5">
                ...
                <div class="text-xxs md:text-xs"><a href="{{route('registration')}}" class="text-white hover:text-white/70 font-bold">Регистрация</a>
                </div>
            </div>
        </x-slot:buttons>
    </x-form.auth-form>
