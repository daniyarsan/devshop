   ...
   {{$socialAuth}}
    ...
    <div class="space-y-3 mt-5">
        <div class="text-xxs md:text-xs">
            <a href="{{route('user.forgot')}}" class="text-white hover:text-white/70 font-bold">Забыли пароль?</a>
        </div>
        <div class="text-xxs md:text-xs">
            <a href="{{route('user.registration')}}" class="text-white hover:text-white/70 font-bold">Регистрация</a>
        </div>
    </div>
